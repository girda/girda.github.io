...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAmChartsAmChartsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppHelpPageHelpPageComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<p>help-page works!</p>\n";
    /***/
  },
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesCompaniesPageCompaniesPageComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesRegisterPageRegisterPageComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesSettingsPageSettingsPageComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<p>settings-page works!</p>\n";
    /***/
  },
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppSharedLayoutsMainLayoutMainLayoutComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAmChartsAmChartsComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAmChartsAmChartsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AmChartsComponent", function () {
      return AmChartsComponent;
    });
    /* harmony import */
    ...
    var _shared_services_am_charts_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../shared/services/am-charts.service */
    ...
    var AmChartsComponent = /*#__PURE__*/function () {
      function AmChartsComponent(zone, amCharts) {
        _classCallCheck(this, AmChartsComponent);

        this.zone = zone;
        this.amCharts = amCharts;
      }

      _createClass(AmChartsComponent, [{
        key: "ngOnInit",
    ...
    AmChartsComponent.ctorParameters = function () {
      return [{
    ...
    AmChartsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-am-charts',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./am-charts.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/am-charts/am-charts.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./am-charts.component.scss */
      "./src/app/am-charts/am-charts.component.scss"))["default"]]
    })], AmChartsComponent);
    /***/
  },
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_layouts_main_layout_main_layout_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./shared/layouts/main-layout/main-layout.component */
    ...
    var _pages_companies_page_companies_page_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./pages/companies-page/companies-page.component */
    "./src/app/pages/companies-page/companies-page.component.ts");
    /* harmony import */


    var _pages_settings_page_settings_page_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var routes = [{
      ...
      path: '',
      component: _shared_layouts_main_layout_main_layout_component__WEBPACK_IMPORTED_MODULE_5__["MainLayoutComponent"],
      children: [{
        path: 'companies',
        component: _pages_companies_page_companies_page_component__WEBPACK_IMPORTED_MODULE_7__["CompaniesPageComponent"]
      }, {
        path: 'settings',
        component: _pages_settings_page_settings_page_component__WEBPACK_IMPORTED_MODULE_8__["SettingsPageComponent"]
      }, {
        path: 'help',
        component: _help_page_help_page_component__WEBPACK_IMPORTED_MODULE_9__["HelpPageComponent"]
      }]
    }];
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_services_companies_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./shared/services/companies.service */
    ...
    var _shared_layouts_auth_layout_auth_layout_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./shared/layouts/auth-layout/auth-layout.component */
    "./src/app/shared/layouts/auth-layout/auth-layout.component.ts");
    /* harmony import */


    var _shared_layouts_main_layout_main_layout_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./shared/layouts/main-layout/main-layout.component */
    "./src/app/shared/layouts/main-layout/main-layout.component.ts");
    /* harmony import */


    var _pages_register_page_register_page_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./pages/register-page/register-page.component */
    "./src/app/pages/register-page/register-page.component.ts");
    /* harmony import */
    ...
    var _pages_companies_page_companies_page_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./pages/companies-page/companies-page.component */
    "./src/app/pages/companies-page/companies-page.component.ts");
    /* harmony import */


    var _help_page_help_page_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./help-page/help-page.component */
    "./src/app/help-page/help-page.component.ts");
    /* harmony import */


    var _pages_settings_page_settings_page_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./pages/settings-page/settings-page.component */
    "./src/app/pages/settings-page/settings-page.component.ts");
    /* harmony import */


    var _am_charts_am_charts_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./am-charts/am-charts.component */
    "./src/app/am-charts/am-charts.component.ts");
    /* harmony import */


    var _shared_services_am_charts_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./shared/services/am-charts.service */
    "./src/app/shared/services/am-charts.service.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_8__["AppComponent"], _login_page_login_page_component__WEBPACK_IMPORTED_MODULE_9__["LoginPageComponent"], _shared_layouts_auth_layout_auth_layout_component__WEBPACK_IMPORTED_MODULE_10__["AuthLayoutComponent"], _shared_layouts_main_layout_main_layout_component__WEBPACK_IMPORTED_MODULE_11__["MainLayoutComponent"], _pages_register_page_register_page_component__WEBPACK_IMPORTED_MODULE_12__["RegisterPageComponent"], _pages_companies_page_companies_page_component__WEBPACK_IMPORTED_MODULE_14__["CompaniesPageComponent"], _help_page_help_page_component__WEBPACK_IMPORTED_MODULE_15__["HelpPageComponent"], _pages_settings_page_settings_page_component__WEBPACK_IMPORTED_MODULE_16__["SettingsPageComponent"], _am_charts_am_charts_component__WEBPACK_IMPORTED_MODULE_17__["AmChartsComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_6__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"]],
  ...
  /***/
  function srcAppHelpPageHelpPageComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppHelpPageHelpPageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HelpPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/help-page/help-page.component.scss"))["default"]]
    })], HelpPageComponent);
    /***/
  },
      ...
      _createClass(LoginPageComponent, [{
        ...
        value: function onSubmit() {
          ...
          this.aSub = this.auth.login(user).subscribe(function () {
            ...
            _this.router.navigate(['/companies']).then(function (r) {
              console.log(r);
            });
  ...
  /***/
  function srcAppPagesCompaniesPageCompaniesPageComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesCompaniesPageCompaniesPageComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CompaniesPageComponent", function () {
    ...
    var CompaniesPageComponent = /*#__PURE__*/function () {
      function CompaniesPageComponent() {
        _classCallCheck(this, CompaniesPageComponent);
      }

      _createClass(CompaniesPageComponent, [{
        key: "ngOnInit",
        // indicators: any[] = [
        //   {
        //     title: 'Финансы',
        ...
        // }
        //
        value: function ngOnInit() {// this.companiesService.updateCompaniesIndicators(this.indicators);
        }
      }]);
    ...
    CompaniesPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-companies-page',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./companies-page.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/companies-page/companies-page.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./companies-page.component.scss */
      "./src/app/pages/companies-page/companies-page.component.scss"))["default"]]
  ...
  /***/
  function srcAppPagesRegisterPageRegisterPageComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppPagesRegisterPageRegisterPageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    RegisterPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/register-page/register-page.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./register-page.component.scss */
      "./src/app/pages/register-page/register-page.component.scss"))["default"]]
  ...
  /***/
  function srcAppPagesSettingsPageSettingsPageComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppPagesSettingsPageSettingsPageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    SettingsPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/settings-page/settings-page.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./settings-page.component.scss */
      "./src/app/pages/settings-page/settings-page.component.scss"))["default"]]
  ...
  /***/
  function srcAppSharedLayoutsAuthLayoutAuthLayoutComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppSharedLayoutsAuthLayoutAuthLayoutComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AuthLayoutComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/shared/layouts/auth-layout/auth-layout.component.scss"))["default"]]
    })], AuthLayoutComponent);
    /***/
  },
  ...
  /***/
  function srcAppSharedLayoutsMainLayoutMainLayoutComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSharedLayoutsMainLayoutMainLayoutComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _services_companies_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../services/companies.service */
    "./src/app/shared/services/companies.service.ts");
    /* harmony import */


    var _services_am_charts_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../services/am-charts.service */
    "./src/app/shared/services/am-charts.service.ts");

    var MainLayoutComponent = /*#__PURE__*/function () {
      function MainLayoutComponent(http, companiesServices, amCharts) {
      ...
      _createClass(MainLayoutComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.companiesServices.getCompanies().then(function (comp) {
            _this2.companies = comp;

            _this2.companies.forEach(function (company) {
              if (company.active) {
                _this2.activeCompanies.push(company);
              }
            });
          });
        }
      }, {
        key: "onChangeBusiness",
        value: function onChangeBusiness(event) {
          var _this3 = this;

          this.companiesServices.getCompanies().then(function (companies) {
            // tslint:disable-next-line:prefer-for-of
            for (var i = 0; i < companies.length; i++) {
              if (event.target.id === companies[i].parent && !event.target.checked) {
                for (var j = 0; j < _this3.activeCompanies.length; j++) {
                  if (_this3.activeCompanies[j].parent === event.target.id) {
                    _this3.activeCompanies.splice(j, 1);

                    _this3.companiesServices.updateActiveCompanies(_this3.activeCompanies);
                  }
                }
              } else if (event.target.id === companies[i].parent) {
                _this3.activeCompanies.push(companies[i]);
            ...
            _this3.activeCompanies.forEach(function (company) {
              debit += company.finance.debit;
              credit += company.finance.credit;
            });

            _this3.indicators.forEach(function (parent) {
              parent.children.forEach(function (indicator) {
        ...
        key: "toggleAccordion",
        value: function toggleAccordion(menu, link) {
          // menu.forEach(item => {
        ...
        key: "toggleActiveCompany",
        value: function toggleActiveCompany(event) {
          this.activeCompanies.forEach(function (company) {
          ...
          for (var i = 0; i < this.activeCompanies.length; i++) {
        ...
        key: "onChangeIndicators",
        value: function onChangeIndicators(event) {
          var _this4 = this;

          this.indicatorElements._results.forEach(function (input) {
            _this4.indicators.forEach(function (indicator) {
          ...
          for (var i = 0; i < this.indicators.length; i++) {
            for (var j = 0; j < this.indicators[i].children.length; j++) {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChildren"])('indicator', null)], MainLayoutComponent.prototype, "indicatorElements", void 0);
    MainLayoutComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/layouts/main-layout/main-layout.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./main-layout.component.scss */
      "./src/app/shared/layouts/main-layout/main-layout.component.scss"))["default"]]
    })], MainLayoutComponent);
    /***/
  },
  ...
  /***/
  function srcAppSharedServicesAmChartsServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AmChartsService", function () {
    ...
    var AmChartsService = /*#__PURE__*/function () {
      function AmChartsService(companiesServices) {
        _classCallCheck(this, AmChartsService);

        this.companiesServices = companiesServices;
      }

      _createClass(AmChartsService, [{
        key: "destroy",
        ...
        value: function render() {
          ...
          var activeCompaniesFlag = false;
          var companies = this.companiesServices.getActiveCompanies();
          var indicators = this.companiesServices.getCompaniesIndicators();
          ...
          if (companies && companies.length && activeCompaniesFlag) {
            indicators.forEach(function (parent) {
              parent.children.forEach(function (indicator) {
                if (indicator.checked) {
                  switch (indicator.id) {
                    case 'debit':
                      _this5._renderDebit(companies, indicator);

                      break;

                    case 'credit':
                      _this5._renderCredit(companies, indicator);
        ...
        key: "_renderDebit",
        value: function _renderDebit(companies, indicator) {
          this.debit = _amcharts_amcharts4_core__WEBPACK_IMPORTED_MODULE_2__["create"]('chart-debit', _amcharts_amcharts4_charts__WEBPACK_IMPORTED_MODULE_3__["XYChart"]); // some extra padding for range labels

          this.debit.paddingBottom = 50; // this.debit.cursor = new am4charts.XYCursor();
          // chart.scrollbarX = new am4core.Scrollbar();
          // will use this to store colors of the same items

          var colors = {};
          var categoryAxis = this.debit.xAxes.push(new _amcharts_amcharts4_charts__WEBPACK_IMPORTED_MODULE_3__["CategoryAxis"]());
          ...
          var valueAxis = this.debit.yAxes.push(new _amcharts_amcharts4_charts__WEBPACK_IMPORTED_MODULE_3__["ValueAxis"]());
          valueAxis.tooltip.disabled = true;
          valueAxis.min = 0; // single column series for all data

          var columnSeries = this.debit.series.push(new _amcharts_amcharts4_charts__WEBPACK_IMPORTED_MODULE_3__["ColumnSeries"]());
          ...
          var valueAxis2 = this.debit.yAxes.push(new _amcharts_amcharts4_charts__WEBPACK_IMPORTED_MODULE_3__["ValueAxis"]());
          valueAxis2.renderer.opposite = true;
          valueAxis2.syncWithAxis = valueAxis;
          valueAxis2.tooltip.disabled = true; // quantity line series

          var lineSeries = this.debit.series.push(new _amcharts_amcharts4_charts__WEBPACK_IMPORTED_MODULE_3__["LineSeries"]());
          ...
          lineSeries.snapTooltip = true; // when data validated, adjust location of data item based on count
          ...
          var chartData = [];
          var lineSeriesData = [];
          var data = {}; // indicator.forEach(parent => {
          //   console.log(parent);
          ...
          companies.forEach(function (company) {
            if (company.active) {
              data[indicator.title]["".concat(company.title.slice(0, 9), "...")] = company.finance.debit;
            }
          });
          console.log(data); // process data ant prepare it for the chart
          ...
          for (var providerName in data) {
            ...
            var _range = categoryAxis.axisRanges.create();

            _range.category = tempArray[0].category;
            _range.endCategory = tempArray[tempArray.length - 1].category;
            _range.label.text = tempArray[0].provider;
            _range.label.dy = 30;
            _range.label.truncate = true;
            _range.label.fontWeight = 'bold';
            _range.label.tooltipText = tempArray[0].provider;

            _range.label.adapter.add('maxWidth', function (maxWidth, target) {
          ...
          this.debit.data = chartData; // last tick
        ...
        key: "_renderCredit",
        value: function _renderCredit(companies, indicator) {
          this.credit = _amcharts_amcharts4_core__WEBPACK_IMPORTED_MODULE_2__["create"]('chart-credit', _amcharts_amcharts4_charts__WEBPACK_IMPORTED_MODULE_3__["XYChart"]); // some extra padding for range labels

          this.credit.paddingBottom = 50; // chart.cursor = new am4charts.XYCursor();
          // chart.scrollbarX = new am4core.Scrollbar();
          // will use this to store colors of the same items

          var colors = {};
          var categoryAxis = this.credit.xAxes.push(new _amcharts_amcharts4_charts__WEBPACK_IMPORTED_MODULE_3__["CategoryAxis"]());
          categoryAxis.dataFields.category = 'category';
          categoryAxis.renderer.minGridDistance = 40;
          categoryAxis.renderer.grid.template.location = 0;
          categoryAxis.dataItems.template.text = '{realName}';
          ...
          var valueAxis = this.credit.yAxes.push(new _amcharts_amcharts4_charts__WEBPACK_IMPORTED_MODULE_3__["ValueAxis"]());
          valueAxis.tooltip.disabled = true;
          valueAxis.min = 0; // single column series for all data

          var columnSeries = this.credit.series.push(new _amcharts_amcharts4_charts__WEBPACK_IMPORTED_MODULE_3__["ColumnSeries"]());
          columnSeries.columns.template.width = _amcharts_amcharts4_core__WEBPACK_IMPORTED_MODULE_2__["percent"](30);
          columnSeries.tooltipText = '{realName}, {valueY}';
          columnSeries.dataFields.categoryX = 'category';
          columnSeries.dataFields.valueY = 'value'; // second value axis for quantity

          var valueAxis2 = this.credit.yAxes.push(new _amcharts_amcharts4_charts__WEBPACK_IMPORTED_MODULE_3__["ValueAxis"]());
          valueAxis2.renderer.opposite = true;
          valueAxis2.syncWithAxis = valueAxis;
          valueAxis2.tooltip.disabled = true; // quantity line series

          var lineSeries = this.credit.series.push(new _amcharts_amcharts4_charts__WEBPACK_IMPORTED_MODULE_3__["LineSeries"]());
          lineSeries.tooltipText = '{valueY}';
          lineSeries.dataFields.categoryX = 'category';
          lineSeries.dataFields.valueY = 'quantity';
          lineSeries.yAxis = valueAxis2;
          ...
          var chartData = [];
          var lineSeriesData = [];
          var data = {}; // indicators.forEach(parent => {
          //   console.log(parent);
          //   parent.children.forEach(indicator => {
          //     if (indicator.checked) {
          //       data[indicator.title] = {};
          ...
          companies.forEach(function (company) {
            if (company.active) {
              data[indicator.title]["".concat(company.title.slice(0, 9), "...")] = company.finance.credit;
            }
          });
          console.log(data); // process data ant prepare it for the chart
          ...
          for (var providerName in data) {
            ...
            var _range2 = categoryAxis.axisRanges.create();

            _range2.category = tempArray[0].category;
            _range2.endCategory = tempArray[tempArray.length - 1].category;
            _range2.label.text = tempArray[0].provider;
            _range2.label.dy = 30;
            _range2.label.truncate = true;
            _range2.label.fontWeight = 'bold';
            _range2.label.tooltipText = tempArray[0].provider;

            _range2.label.adapter.add('maxWidth', function (maxWidth, target) {
              var range = target.dataItem;
              var startPosition = categoryAxis.categoryToPosition(range.category, 0);
              var endPosition = categoryAxis.categoryToPosition(range.endCategory, 1);
              var startX = categoryAxis.positionToCoordinate(startPosition);
          ...
          this.credit.data = chartData; // last tick
    ...
    AmChartsService.ctorParameters = function () {
      return [{
        type: _companies_service__WEBPACK_IMPORTED_MODULE_5__["CompaniesService"]
      }];
    };

    AmChartsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], AmChartsService);
    /***/
  },
  ...
  /***/
  function srcAppSharedServicesCompaniesServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var CompaniesService = /*#__PURE__*/function () {
      ...
      _createClass(CompaniesService, [{
        key: "updateActiveCompanies",
        value: function updateActiveCompanies(companies) {
          this.activeCompanies = companies;
        }
      }, {
        key: "updateCompaniesIndicators",
        value: function updateCompaniesIndicators(indicators) {
        ...
        value: function getCompanies() {
          ...
          return new Promise(function (resole, reject) {
            if (_this6.companies.length) {
              resole(_this6.companies);
            } else {
              return _this6.http.get('/assets/companies.json').subscribe(function (res) {
                _this6.companies = res;
                resole(_this6.companies);
              }, function (error) {
                reject(error);
              });
        ...
        key: "getCompaniesIndicators",
        value: function getCompaniesIndicators() {
    ...
    CompaniesService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], CompaniesService);
    /***/
  },
